...
export default function PropertyPage() {
  return (
    <ServicePage
      ...
      intro="Property is one of our deepest areas of experience. We position, structure and advise on projects across Thailand and Asia, focused on strategy and execution rather than listing transactions."
